...
#            self.epsilon = self.epsilon - 0.05 
            ...
            # ----------
            # Question 7. Improved Q-Learning Simulation Results
            self.t += 1 # update t here first to avoid divide by zero error in some decay function
                        
            # choose one of the 4 sample of decaying functions 
            # 1. epsilon = exp(-at)
...
#            self.epsilon = math.cos(self.alpha*self.t)
    ...
    def createQ(self, state):
        ...
        if self.learning == True:
            ...
            # Q table check if state already exist
            if self.Q.has_key(state) == False:

                # add state with all actions default to 0.0 
                self.Q[state] = {}
    ...
    def choose_action(self, state):
        ...
        # Question 3. Implement a Basic Driving Agent
...
#        return maxQ_actions
    ...
    def learn(self, state, action, reward):
        ...
        # Question 6. Implement a Q-Learning Driving Agent
        if self.learning == True:            
            # udacity forum hint found - Q Learning logic
